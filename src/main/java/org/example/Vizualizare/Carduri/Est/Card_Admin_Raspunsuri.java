...
@Getter @Setter
public class Card_Admin_Raspunsuri extends JPanel implements ActionListener, I_Tematica{
    private Card_Setari_Raspuns cardAdaugareRaspuns;
    ...
    public Card_Admin_Raspunsuri(I_Carduri interfataCard, Card_Setari_Raspuns cardAdaugareRaspuns, I_BtnActiuni interfataBtnActiuni, I_FrontEnd interfataFrontEnd, Color culoareComponentaArg, String fontArg, int tipTextArg, int dimensiuneTextArg, Color culoareButonArg,
                                 boolean focusareButonArg, boolean focusareDesenButonArg) {
        this.cardAdaugareRaspuns = cardAdaugareRaspuns;
        this.interfataCard = interfataCard;
        this.interfataBtnActiuni = interfataBtnActiuni;
        this.interfataFrontEnd = interfataFrontEnd;
        configurari("Setari", "Setări Răspunsuri");
