...
@Getter @Setter
public class Card_PlasareComanda extends JPanel implements ActionListener, I_Tematica{
    ...
    public Card_PlasareComanda(I_Carduri interfataCard, Card_Setari_PlasareComanda cardSetariPlasareComanda, I_BtnActiuni interfataBtnActiuni, I_FrontEnd interfataFrontEnd, Color culoareComponentaArg, String fontArg, int tipTextArg, int dimensiuneTextArg, Color culoareButonArg,
                                     boolean focusareButonArg, boolean focusareDesenButonArg) {
        this.cardSetariPlasareComanda = cardSetariPlasareComanda;
        this.interfataCard = interfataCard;
        this.interfataBtnActiuni = interfataBtnActiuni;
        this.interfataFrontEnd = interfataFrontEnd;
        configurari("PlasareComanda", "Plasare Comandă");
    ...
    public void configurari(String urlTitluIcon, String textIcon) {
        ...
        sb.append("<html>");
        sb.append("<img src=\"").append(getClass().getResource("/Imagini/MeniuriProgram/" + urlTitluIcon + ".png")).append("\">");
    ...
    public void asezareElemente() {
        ...
        gc.gridy = 0;
        gc.gridwidth = 5;
        add(getCardSetariPlasareComanda(), gc);
