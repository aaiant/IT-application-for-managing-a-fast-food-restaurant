...
@Getter @Setter
public class Card_Admin_CosCumparaturi extends JPanel implements ActionListener, I_Tematica{
    ...
    public Card_Admin_CosCumparaturi(I_Carduri interfataCard, Card_Setari_CosCumparaturi cardSetariCosCumparaturi, I_BtnActiuni interfataBtnActiuni, I_FrontEnd interfataFrontEnd, Color culoareComponentaArg, String fontArg, int tipTextArg, int dimensiuneTextArg, Color culoareButonArg,
                                    boolean focusareButonArg, boolean focusareDesenButonArg) {
        this.cardSetariCosCumparaturi = cardSetariCosCumparaturi;
        this.interfataCard = interfataCard;
        this.interfataBtnActiuni = interfataBtnActiuni;
        this.interfataFrontEnd = interfataFrontEnd;
        configurari("DetaliiProdus", "Modificare Coș");
    ...
    public void asezareElemente() {
        ...
        gc.gridy = 0;
        gc.gridwidth = 5;
        add(getCardSetariCosCumparaturi(), gc);
