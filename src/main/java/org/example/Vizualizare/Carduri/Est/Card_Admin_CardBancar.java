...
@Getter @Setter
public class Card_Admin_CardBancar extends JPanel implements ActionListener, I_Tematica{
    private Card_Setari_CardBancar cardSetariCardBancar;
    ...
    public Card_Admin_CardBancar(I_Carduri interfataCard, Card_Setari_CardBancar cardSetariCardBancar, I_BtnActiuni interfataBtnActiuni, I_FrontEnd interfataFrontEnd, Color culoareComponentaArg, String fontArg, int tipTextArg, int dimensiuneTextArg, Color culoareButonArg,
                                 boolean focusareButonArg, boolean focusareDesenButonArg) {
        this.cardSetariCardBancar = cardSetariCardBancar;
        this.interfataCard = interfataCard;
        this.interfataBtnActiuni = interfataBtnActiuni;
        this.interfataFrontEnd = interfataFrontEnd;
        configurari("Setari", "Setări Card Bancar");
    ...
    private void initializari(Color culoareComponentaArg, String fontArg, int tipTextArg, int dimensiuneTextArg, Color culoareButonArg,
        ...
        getInchidereButon().setFont(new Font("Times New Romans", Font.PLAIN, 16));
    ...
    public void asezareElemente() {
        ...
        gc.gridy = 0;
        gc.gridwidth = 5;
        add(getCardSetariCardBancar(), gc);
