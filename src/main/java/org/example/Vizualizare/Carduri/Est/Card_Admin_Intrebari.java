...
@Getter @Setter
public class Card_Admin_Intrebari extends JPanel implements ActionListener, I_Tematica{
    private Card_Setari_Intrebare cardAdaugareIntrebare;
    ...
    public Card_Admin_Intrebari(I_Carduri interfataCard, Card_Setari_Intrebare cardAdaugareIntrebare, I_BtnActiuni interfataBtnActiuni, I_FrontEnd interfataFrontEnd, Color culoareComponentaArg, String fontArg, int tipTextArg, int dimensiuneTextArg, Color culoareButonArg,
                                boolean focusareButonArg, boolean focusareDesenButonArg) {
        this.cardAdaugareIntrebare = cardAdaugareIntrebare;
        this.interfataCard = interfataCard;
        this.interfataBtnActiuni = interfataBtnActiuni;
        this.interfataFrontEnd = interfataFrontEnd;
        configurari("Setari", "Setări Întrebare");
    ...
    public void asezareElemente() {
        ...
        gc.gridy = 0;
        gc.gridwidth = 5;
        add(getCardAdaugareIntrebare(), gc);
